var initTimeline = function () { //input data will be passed as param
    ...
    $.each(data, function (index, event) {
        events.append('<li><a href="#0" data-date="' + event + '" ' + selectedClass + '>' + event + '</a></li>');
...
jQuery(document).ready(function ($) {
    initTimeline().promise().done(function () {
        var timelines = $('#ttp-events'),
